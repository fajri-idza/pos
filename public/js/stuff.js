jQuery(function ($) {
	...
	const edit = ({idBuku, category, rack, barcode, noisbn, judul, penulis, penerbit, tahun, hargaPokok, hargaJual, hargaReseller, disc, rak}) => {
		const modal = $('#edit')
        ...
        modal.find('[name=hargaReseller]').val(hargaReseller)
