...
class Create extends Component
{
	...
	protected $listeners = [
		...
		'error-limit' => 'limit',
		'reset-id' => 'setId',
        'clear-purchaser' => 'clearPurchaser',
	];
    ...
    public function clearPurchaser()
    {
	...
	{
        $harga = $this->buyerType === 'reseller' ? $stuff->hargaReseller : $stuff->hargaJual;
        ...
        $this->emit('send-purchaser-data', $this->pembeli);
	}
